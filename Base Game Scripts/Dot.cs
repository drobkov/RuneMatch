...
public class Dot : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        shineDelay = Random.Range(3f, 6f); //Задержка блеска в анимации.
    ...
    /* private void OnMouseOver()
    {
        if (Input.GetMouseButtonDown(1))
        {
            ...
            //Создает при нажатии на правую кнопку мыши бомбочку в любом месте где нажнем. 
            isAdjacentBomb = true;
    ...
    */
    ...
    void Update()
    {
     ...
     /* IEnumerator StartShineCo(){
        ...
        {
                Debug.Log("Animator component is missing on the object " + gameObject.name);
        }
    }
    */
    ...
    public IEnumerator CheckMoveCo(){ 
        // Ассинхрон действий. Возврат объекта на своё место если нет совпадений. 
        if (isColorBomb)
        {
    ...
    void MovePiecesActual(Vector2 direction){
        ...
        if (board.lockTiles[column, row] == null && board.lockTiles[column + (int)direction.x, row + (int)direction.y] == null)
        {
            if (otherDot != null)
            {
                ...
                row += (int)direction.y;
                StartCoroutine(CheckMoveCo()); // Ассинхрон действий.
            }
            else{
                board.currentState = GameState.move;
            }
